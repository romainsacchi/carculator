...
class ExportInventory:
    ...
    def __init__(self, array, indices, db_name="carculator_utils export"):
    ...
    def write_lci_to_excel(
        ...
        if software_compatibility == "brightway2":
            ...
            if export_format == "string":
                ...
                frmt = lambda x: bold if row[0] in highlighted else None
                sheet = workbook.add_worksheet("carculator_utils export")
    ...
    def format_data_for_lci_for_simapro(
        ...
        for a in data:
            ...
            for item in fields:
                ...
                if item == "Generator":
                    rows.append(["carculator_utils " + str(__version__)])
